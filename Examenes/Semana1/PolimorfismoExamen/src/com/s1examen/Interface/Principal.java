package com.s1examen.Interface;
...
public class Principal {
	 ...
	 * canción elegida.
	 * 
	 * El único cambio que hubo en comparación con la clase abstracta 
	 * es que, para buscar "Reproducciones" en el for el programa pidió 
	 * cambiar la ruta y acceder desde la interfaz.
	 * @return
	 * 
	 */
	public static Canciones getCanciones() {
		...
		for(Canciones o:canciones) {
				...
				System.out.println("Reproducciones: "+ Canciones.Reproducciones()+1);
